...
const AdminsPortal: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Admin Portal – Simplify School Management - Dumroo.ai</title>
        <meta name="description" content="Streamline operations with the Admin Portal manage performance analytics, reports, and institutional data with ease." />
        
        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Admin Portal – Simplify School Management - Dumroo.ai" />
        <meta property="og:description" content="Streamline operations with the Admin Portal manage performance analytics, reports, and institutional data with ease." />
        <meta property="og:url" content="https://dumroo.ai/portals/admin-portal" />
        <meta property="og:type" content="website" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Admin Portal – Simplify School Management - Dumroo.ai" />
        <meta name="twitter:description" content="Streamline operations with the Admin Portal manage performance analytics, reports, and institutional data with ease." />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://dumroo.ai/portals/admin-portal" />
      </Helmet>
      <Navigation />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="text-center">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
                Admin Portal – Simplify School Management - Dumroo.ai
              </h1>
