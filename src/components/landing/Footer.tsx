...
const socialClasses = {
  ...
  instagram: "bg-linear-to-br from-[#F58529] via-[#DD2A7B] to-[#8134AF] hover:shadow-[#DD2A7B]/30",
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
        ...
        <nav aria-label="Resources" className="space-y-4">
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li>
              <Link to="/terms" className="hover:text-brand-aux1 transition-colors">
                Terms of Service
              </Link>
            </li>
            <li>
        ...
        <section className="space-y-6">
          ...
          >
            <input
              ...
              className={cn(
                "flex-1 min-w-0 rounded-lg px-4 py-2 bg-white text-gray-900",
